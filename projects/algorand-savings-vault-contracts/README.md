# algorand-savings-vault-contracts
...
By default the template creates a single `HelloWorld` contract under algo_vault folder in the `smart_contracts` directory. To add a new contract:
